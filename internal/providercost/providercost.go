// Package providercost measures what a request cost Relay upstream.
//
// This is the one place in the repository that holds an amount of money, and it
// is deliberately not the contract's. ADR 0006 gives Relay upstream provider
...
// moment one type answers both, Relay has started a second ledger.
//
...
//
// It matches the published contract's money scale on purpose. Relay never
...
// currencyPattern is the shape of an ISO 4217 code. Relay does not hold a
